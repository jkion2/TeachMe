...
function processUploadedFile(file){
  ...
  //clear the text input when the image is uploaded
  textInput.value = ""
...
function setupDragAndDrop(){
  const dropZone = document.getElementById('imageInput').parentElement //we can create a specific drop zone
  ...
  dropZone.addEventListener('drop', (e) => {
    ...
    if(files.length > 0){
      ...
      //update the file input to reflect our newly dropped file
